...
class MemberFunctionTests(DirectResultQueryTests):
    ...
    def test_qualified_function_name_prefix_sensitive(self):
        ...
        name should take you directly to the result. This should have precedence 
        over any case-insensitive match"""
        raise SkipTest("Skipping test for unique case sensitive matches on function names")
        self.direct_result_eq('MemberFunction::member_function', 14)

    def test_qualified_function_name_prefix_multiple_matches(self):
        """Multiple prefix matches on fully qualified function 
    ...
    def test_qualified_type_name_sensitive(self):
        ...
        name should take you directly to the result. This should have precedence 
        over any case-insensitive match"""
        raise SkipTest("Skipping test for unique case sensitive matches on type names")
        self.direct_result_eq('MemberFunction::InnerClass', 8)

    def test_qualified_type_name_multiple_matches(self):
        """Multiple prefix matches on fully qualified type 
        name should return None"""
