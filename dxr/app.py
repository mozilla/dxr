...
def make_app(instance_path=None, www_root=''):
    """Return a DXR application which looks in the ``instance_path`` folder for
    configuration.
    ...
    will suffice to support ``url_of()``.
    ...
    if instance_path:
        ...
        app.config.from_pyfile(join(instance_path, 'config.py'))
        www_root = app.config['WWW_ROOT']
