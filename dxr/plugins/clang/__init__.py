...
from dxr.plugins.clang.filters import (FunctionFilter, FunctionRefFilter, FunctionDeclFilter, TypeRefFilter, TypeDeclFilter, TypeFilter,
    VariableFilter, VariableRefFilter, VarDeclFilter, MacroFilter,
    MacroRefFilter, NamespaceFilter, NamespaceRefFilter, NamespaceAliasFilter,
    NamespaceAliasRefFilter, WarningFilter, WarningOptFilter, CalleeFilter,
    CallerFilter, ChildFilter, ParentFilter, MemberFilter, OverridesFilter,
    OverriddenFilter)
